import 'package:app_food/screens/detail/meal_detail_screen.dart';
...
import '../../../services/Meal_Data.dart';
...
class MostWatchedBox extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<MealModel>>(
      future: MealData.GetMealByFirstChar('k'),
